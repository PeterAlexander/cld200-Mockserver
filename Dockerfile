...
ARG YFchCPmYbVlzRiBa05AHDY96xhmD9y32
RUN curl -H "apikey:YFchCPmYbVlzRiBa05AHDY96xhmD9y32" "https://sandbox.api.sap.com/s4hanacloud/sap/opu/odata/sap/API_BUSINESS_PARTNER/$metadata" | xmllint --format - > API_BUSINESS_PARTNER.edmx
